...
export const RoleEdit = () => {
    ...
    useEffect(() => {
        if (record?.permissions && Array.isArray(record.permissions)) {
            ...
            if (perms.includes('*')) {
                finalPermissions = permissionTree.flatMap(module =>
            ...
            formProps.form?.setFieldsValue({ permissions: finalPermissions });
        }
    }, [record, formProps.form, permissionTree]);
    ...
    const columns = [
        {
            ...
            render: (value: string, record: TableRecord) => {
                ...
                return (
                    ...
                    ><Text strong>{value}</Text></Checkbox>
                );
            },
        },
        {
            ...
            render: (feature: { name: string; permissions: { value: string; action: string }[] }) => {
                ...
                return (
                    <Row align="middle">
                        <Col span={6}>
                            <Checkbox checked={isFeatureChecked} indeterminate={isFeatureIndeterminate}
                    ...
                    <Row gutter={24}>
                        ...
                        <Col span={24}>
                            <Card title={t('rolePage.permissionConfig')}>
                                <Form.Item name="permissions" rules={[{ required: true, message: t('rolePage.permissionRequired') }]} style={{ display: 'none' }}>
